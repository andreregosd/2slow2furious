...
create table public."DriversTeams" (
  season_id smallint not null,
  driver_id smallint not null,
  team_id smallint not null,
  constraint DriversTeams_pkey primary key (season_id, driver_id, team_id),
  constraint DriversTeams_season_id_fkey foreign KEY (season_id) references "Seasons" (id),
  constraint DriversTeams_driver_id_fkey foreign KEY (driver_id) references "Drivers" (id),
  constraint DriversTeams_team_id_fkey foreign KEY (team_id) references "Teams" (id)
) TABLESPACE pg_default;
...
INSERT INTO "Drivers" ("name") VALUES ('André');
INSERT INTO "Drivers" ("name") VALUES ('Ribeiro');
INSERT INTO "Drivers" ("name") VALUES ('Alex');
INSERT INTO "Drivers" ("name") VALUES ('Dany');
INSERT INTO "Drivers" ("name") VALUES ('Bruno');
INSERT INTO "Drivers" ("name") VALUES ('Ruben');

INSERT INTO "DriversTeams" ("season_id", "driver_id", "team_id") VALUES (1, 1, 1);
INSERT INTO "DriversTeams" ("season_id", "driver_id", "team_id") VALUES (1, 2, 2);
INSERT INTO "DriversTeams" ("season_id", "driver_id", "team_id") VALUES (1, 3, 3);
INSERT INTO "DriversTeams" ("season_id", "driver_id", "team_id") VALUES (1, 4, 3);
INSERT INTO "DriversTeams" ("season_id", "driver_id", "team_id") VALUES (1, 5, 1);
INSERT INTO "DriversTeams" ("season_id", "driver_id", "team_id") VALUES (1, 6, 2);
